...
- (id)init
{
    ...
    if (self) {
        _navigationTypeDefault = RONavigationTypeSliding;
    }
    return self;
}
...
- (void)process
{
    ...
    NSDictionary *textAttributes = @{
                                     ...
                                     NSFontAttributeName : [self fontWithSize:[self.fontSize floatValue] * 1.3f]
                                     };
    ...
    //[[UILabel appearanceWhenContainedIn:[ROCollectionViewCell class], nil] setTextColor:self.foregroundColor];
    
    // UITableViewCell
    
    //[[UILabel appearanceWhenContainedIn:[ROTableViewCell class], nil] setTextColor:self.foregroundColor];
    
    //[[UILabel appearanceWhenContainedIn:[ROTableViewCell class], nil] setFont:[self font]];
