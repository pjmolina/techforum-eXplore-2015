...
@interface ROFormFieldDateRange ()

@property (nonatomic, strong) NSDateFormatter *dateFormatter;

@end

@implementation ROFormFieldDateRange
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        ...
        cell.detailTextLabel.font = [[ROStyle sharedInstance] fontWithSize:[[[ROStyle sharedInstance] fontSize] floatValue]];
