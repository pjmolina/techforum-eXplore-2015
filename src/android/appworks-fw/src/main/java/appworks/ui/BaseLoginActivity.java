...
import appworks.R;
import appworks.services.LoginService;
import appworks.util.SecurePreferences;
...
public abstract class BaseLoginActivity extends BaseActivity {
    ...
    public void attemptLogin() {
        ...
        mLoginService = createLoginService();
        ...
        if (cancel) {
            ...
            mLoginService.attemptLogin(mEmail, mPassword);
        }
    }
