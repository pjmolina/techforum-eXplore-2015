...
import appworks.R;
import appworks.dialogs.SelectionDialog;
...
public class ListSelectionPicker extends LinearLayout {
    ...
    public ListSelectionPicker setSelectionDialog(SelectionDialog dialog) {
        ...
        if(mDialog != null) {
            // Attach callback
            mDialog.setSelectionListener(new SelectionDialog.SelectionListener() {
                @Override
    ...
    private void setPicker() {
        ...
        this.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putStringArrayList(SelectionDialog.INITIAL_VALUES, mValues);
