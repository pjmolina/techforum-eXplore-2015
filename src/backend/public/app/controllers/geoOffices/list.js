angular.module('myApp').controller('ListGeoOfficesController', ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'NavigationService', 'EntityUtilService', 'GeoOfficesService', function($http, $scope, $location, $q, $timeout, $modal, NavigationService, EntityUtilService, GeoOfficesService) {
	...
	$scope.add = function () {
		$location.path('/geoOffices/add');
	};

	$scope.edit = function (obj) {
		$location.path('/geoOffices/edit/' + obj._id);
	};
	$scope.view = function (obj) {
		$location.path('/geoOffices/view/' + obj._id);
	};
	$scope.delete = function (obj) {
		$location.path('/geoOffices/delete/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(GeoOfficesService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(GeoOfficesService, $scope.dataList, $scope.refresh);  
	}
	...
	$scope.importData = function () {
		...
		$location.path('/import/geoOffices');		
	};
	$scope.exportAs = function (format) { 
		EntityUtilService.exportAsFormat(
			...
			GeoOfficesService, "geoOffices", $scope);
		$scope.ui.dropdown.isOpen = false;
	};
	//-----------------------------
