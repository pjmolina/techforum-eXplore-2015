angular.module('myApp').controller('ListSolutionController', ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'NavigationService', 'EntityUtilService', 'SolutionService', function($http, $scope, $location, $q, $timeout, $modal, NavigationService, EntityUtilService, SolutionService) {
	...
	$scope.add = function () {
		$location.path('/solution/add');
	};

	$scope.edit = function (obj) {
		$location.path('/solution/edit/' + obj._id);
	};
	$scope.view = function (obj) {
		$location.path('/solution/view/' + obj._id);
	};
	$scope.delete = function (obj) {
		$location.path('/solution/delete/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(SolutionService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(SolutionService, $scope.dataList, $scope.refresh);  
	}
	...
	$scope.exportAs = function (format) { 
		EntityUtilService.exportAsFormat(
			...
			SolutionService, "solutions", $scope);
		$scope.ui.dropdown.isOpen = false;
	};
	//-----------------------------
